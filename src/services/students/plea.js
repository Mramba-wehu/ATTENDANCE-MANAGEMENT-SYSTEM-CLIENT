...
var API_URL = '/api/pleas';
export var getPleas = function (courseCode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || 'Failed to get Pleas',
...
export var newPlea = function (plea) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_2 === null || error_2 === void 0 ? void 0 : error_2.message) || 'Failed to add Plea',
...
export var deletePlea = function (_id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch(API_URL, {
                        method: 'DELETE',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ body: security.encrypt({ _id: _id }) })
                    })];
            case 1:
                response = _c.sent();
                _b = (_a = security).decrypt;
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_3 === null || error_3 === void 0 ? void 0 : error_3.message) || 'Failed to delete Plea',
