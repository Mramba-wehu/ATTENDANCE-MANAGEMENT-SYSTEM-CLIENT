    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || 'Failed to fetch users',
...
export var updateUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, _a, _b, error_2;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("".concat(API_URL, "/update"), {
                        method: 'PUT',
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_2 === null || error_2 === void 0 ? void 0 : error_2.message) || 'Failed to update user',
...
export var blockUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, _a, _b, error_3;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("".concat(API_URL, "/block"), {
                        method: 'PUT',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ body: security.encrypt(user) })
                    })];
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_3 === null || error_3 === void 0 ? void 0 : error_3.message) || 'Failed to update user',
...
export var deleteUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        status: false,
                        msg: (error_4 === null || error_4 === void 0 ? void 0 : error_4.message) || 'Failed to update user',
