        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                ...
                case 9:
                    ...
                    selectedCourseCode = currentCourse.value;
                    if (!selectedCourseCode) {
                        throw new Error('Invalid course selected');
                    }
                ...
                case 10:
                    ...
                    if (res.status && Array.isArray(res.data.pleas)) {
                        pleaList.value = res.data.pleas.map(function (p) { return (__assign(__assign({}, p), { scheduledDate: new Date(p.scheduledDate) })); });
...
var handleValidateQR = function () {
    var args_1 = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args_1[_i] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (data) {
        var res, error_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    serverRequest.value = true;
                    return [4 /*yield*/, validateQR(data, auth.regNO)];
                case 2:
                    res = _a.sent();
                    feed.value = {
                        show: true,
                    ...
                    if (res.status) {
                        setTimeout(function () { return activeTab.value = 'classes'; }, 1000);
                    }
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
                    feed.value = {
                        show: true,
                        status: false,
                        msg: error_1.message || 'Unable to validate QR Code'
                    };
                    return [3 /*break*/, 5];
                case 4:
                    setTimeout(function () {
...
var onDetect = function (data) {
    scannedData.value = data;
    handleValidateQR(data);
};
var attendClass = function (item) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                _a.sent();
                pleaList.value.forEach(function (plea) {
...
watch(scheduleTable, function (el) {
    if (el) {
        var existing = $(el).DataTable();
        if (existing)
            existing.destroy();
        $(el).DataTable();
    }
});
watch(scheduleList, function (newVal, oldVal) {
    if (newVal !== oldVal) {
        newVal.forEach(function (schedule) {
            if (schedule.attended) {
                var attended = secureQR(schedule.attended, false);
                attended.forEach(function (user) {
                    var _a, _b;
                    if (((_a = user.student) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === ((_b = auth.regNO) === null || _b === void 0 ? void 0 : _b.toLowerCase())) {
...
watch(activeTab, function (newTab) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                scheduleList.value = [];
                if (!(newTab === 'classes')) return [3 /*break*/, 6];
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, fetchServer('schedules', false)];
            case 4:
                _a.sent();
                return [4 /*yield*/, nextTick()];
            case 5:
...
var __VLS_exposed = { QrcodeStream: QrcodeStream, onDetect: onDetect, getTitle: getTitle, handleValidateQR: handleValidateQR, attendClass: attendClass, done: done, formatDate: formatDate };
