...
var handleSubmitNote = function () { return __awaiter(void 0, void 0, void 0, function () {
    var selectedCourseCode, schema, data, _a, status_2, error, res_1, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                selectedCourseCode = (_b = course.value) === null || _b === void 0 ? void 0 : _b.courseCode;
                if (!selectedCourseCode) {
                    throw new Error('Invalid course selected');
                }
                else {
            ...
            case 2:
                _a = _c.sent(), status_2 = _a.status, error = _a.error;
                if (!status_2) {
                    errors.value = error;
                    return [2 /*return*/];
                }
                serverRequest.value = true;
                return [4 /*yield*/, newNote(data)];
            case 3:
                res_1 = _c.sent();
                setTimeout(function () {
                    feed.value = {
                        show: true,
                        status: res_1.status ? false : true,
                        msg: res_1.data ? res_1.data.message : res_1.msg || 'Note added succesfully'
                    };
                    if (res_1.status)
                        setTimeout(done, 500);
                }, 1500);
            ...
            case 4:
                ...
                feed.value = {
                    show: true,
                    status: false,
                    msg: error_1.message || 'Unable to update Note'
                };
                return [3 /*break*/, 6];
            case 5:
                setTimeout(function () {
                ...
                case 2:
                    ...
                    setTimeout(function () {
                        feed.value = {
                            ...
                            msg: (res_2 === null || res_2 === void 0 ? void 0 : res_2.status) ? res_2.msg : 'Download failed'
                        };
                        if (res_2 === null || res_2 === void 0 ? void 0 : res_2.status)
                            setTimeout(done, 500);
                    }, 1000);
                    return [3 /*break*/, 5];
                case 3:
                    ...
                    feed.value = {
                        show: true,
                        status: false,
                        msg: error_2.message || 'Unable to download note'
                    };
                    return [3 /*break*/, 5];
                case 4:
                    setTimeout(function () {
...
var handleDeleteNote = function () {
    var args_1 = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args_1[_i] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (unitCode) {
        var res_3, error_3;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    serverRequest.value = true;
                    return [4 /*yield*/, deleteNote(unitCode)];
                case 2:
                    res_3 = _a.sent();
                    setTimeout(function () {
                        feed.value = {
                            show: true,
                            status: (res_3 === null || res_3 === void 0 ? void 0 : res_3.status) ? true : false,
                            msg: (res_3 === null || res_3 === void 0 ? void 0 : res_3.status) ? res_3.data.message : res_3.msg || 'Unable to delete note'
                        };
                        if (res_3.status) {
                            notesList.value = notesList.value.filter(function (note) { return note.unitCode !== unitCode; });
                            setTimeout(function () {
                                done();
                            }, 500);
                        }
                ...
                case 3:
                    ...
                    feed.value = {
                        show: true,
                        status: false,
                        msg: error_3.message || 'Unable to delete note'
                    };
                    return [3 /*break*/, 5];
                case 4:
                    setTimeout(function () {
...
watch(activeTab, function (newTab) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, fetchServer('notes', false)];
            case 4:
                _a.sent();
...
var __VLS_exposed = { activeTab: activeTab, onFileChange: onFileChange, handleSubmitNote: handleSubmitNote, handleDownloadNote: handleDownloadNote, handleDeleteNote: handleDeleteNote, done: done, getTitle: getTitle };
