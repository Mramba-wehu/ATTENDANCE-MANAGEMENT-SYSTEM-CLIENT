...
var handleSubmitTempo = function () { return __awaiter(void 0, void 0, void 0, function () {
    var selectedCourseCode, schema, schedule_data, _a, status_2, error, res_1, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Validate(schema, schedule_data)];
            case 2:
                ...
                serverRequest.value = true;
                return [4 /*yield*/, newTempo(schedule_data)];
            case 3:
                res_1 = _c.sent();
                setTimeout(function () {
                    feed.value = {
                        ...
                        msg: res_1.data ? res_1.data.message : res_1.msg || 'Tempo added succesfully'
                    };
                    if (res_1.status)
                        setTimeout(done, 500);
                }, 1500);
            ...
            case 4:
                ...
                feed.value = {
                    show: true,
                    status: false,
                    msg: error_1.message || 'Unable to update schedule'
                };
                return [3 /*break*/, 6];
            case 5:
                setTimeout(function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    serverRequest.value = true;
                    return [4 /*yield*/, deleteTempo(unitCode)];
                case 2:
                    res_2 = _a.sent();
                    if (res_2.status) {
                        scheduleList.value = scheduleList.value.filter(function (s) { return s.unitCode !== unitCode; });
                    }
                    setTimeout(function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            feed.value = {
                                show: true,
                                status: res_2.status,
                                msg: res_2.data ? res_2.data.message : res_2.msg || 'Schedule removed succesfully'
                            };
                            if (res_2.status) {
                            }
                            return [2 /*return*/];
                ...
                case 3:
                    ...
                    feed.value = {
                        show: true,
                        status: false,
                        msg: error_2.message || 'Unable to remove schedule'
                    };
                    return [3 /*break*/, 5];
                case 4:
                    setTimeout(function () { return __awaiter(void 0, void 0, void 0, function () {
...
var __VLS_exposed = { formatDate: formatDate, formatTime: formatTime, activeTab: activeTab, removeSchedule: removeSchedule, handleSubmitTempo: handleSubmitTempo, done: done, getTitle: getTitle };
