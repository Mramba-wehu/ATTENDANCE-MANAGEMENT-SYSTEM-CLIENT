...
var fetchServer = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (target, multiple) {
        var res, status_1, msg, selectedCourseCode, now_1, err_1;
...
var generateQR = function (courseCode, unitCode, date, time) { return __awaiter(void 0, void 0, void 0, function () {
    var encodedQRData, _a, res, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                encodedQRData = secureQR(rawData.value);
                _a = qrData;
                return [4 /*yield*/, QRCode.toDataURL(encodedQRData)];
            case 2:
                _a.value = _b.sent();
                serverRequest.value = true;
                return [4 /*yield*/, newQR(encodedQRData)];
            case 3:
                res = _b.sent();
                if (res.status) {
                    activeTab.value = 'qr';
            ...
            case 4:
                ...
                feed.value = {
                    show: true,
                    status: false,
                    msg: error_1.message || 'Unable to remove schedule'
                };
                return [3 /*break*/, 6];
            case 5:
                setTimeout(function () {
...
var __VLS_exposed = { generateQR: generateQR, done: done, getTitle: getTitle, formatDate: formatDate, formatTime: formatTime };
