...
var fetchServer = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (target, multiple) {
        var res, status_1, msg, selectedCourseCode, now_1, selectedCourseCode, err_1;
            ...
            switch (_p.label) {
                ...
                case 10:
                    ...
                    if (!res.status)
                        multiple = res.status;
                    status_1 = res.status;
                    msg = (_o = (_m = res.data) === null || _m === void 0 ? void 0 : _m.message) !== null && _o !== void 0 ? _o : res.msg;
                    _p.label = 11;
                case 11:
                    if (!multiple) {
                        feed.value = {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!((_a = selected.value) === null || _a === void 0 ? void 0 : _a._id)) {
                        throw new Error('Invalid plea');
                    }
                    pleaAction.value = action;
                    payload = { id: selected.value._id, action: action };
                    serverRequest.value = true;
                    return [4 /*yield*/, updatePleaStatus(payload)];
                case 1:
                    res = _c.sent();
                    feed.value = {
                        show: true,
                        status: res.status,
                        msg: res.data ? (_b = res.data) === null || _b === void 0 ? void 0 : _b.message : res.msg
                    };
                ...
                case 9:
                    ...
                    feed.value = {
                        show: true,
                        status: false,
                        msg: err_2.message || 'Failed to fetch from server'
                    };
                    return [3 /*break*/, 11];
                case 10:
                    setTimeout(function () {
...
var viewPlea = function (plea) {
    ...
    var el = document.getElementById('pleaModal');
    if (!el) {
...
var done = function () {
    var _a;
    (_a = document.getElementById('close-modal')) === null || _a === void 0 ? void 0 : _a.focus();
};
...
var __VLS_exposed = { viewPlea: viewPlea, done: done, getTitle: getTitle, formatDate: formatDate, formatTime: formatTime, handlePleaStatus: handlePleaStatus };
